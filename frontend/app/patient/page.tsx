  ...
  return (
    <div className="h-screen w-full flex bg-[#02476D] font-sans">
      ...
      <div className="w-full md:w-3/4 flex flex-col">
        <div className="w-full flex flex-col space-y-6 h-full px-12 py-7.5 bg-white rounded-2xl text-[#003552] overflow-hidden">
          {/* Breadcrumb */}
              ...
              >
                ...
                <div className="flex flex-col items-end justify-between z-10">
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-white bg-[#16929C] font-medium hover:bg-[#0e7880] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0C3B5E] transition-colors duration-200"
                  >
                    Lihat Selengkapnya
                    <ArrowRight />
                  </button>
