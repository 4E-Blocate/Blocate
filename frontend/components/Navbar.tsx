...
function Navbar() {
    ...
    return (
        <nav className={`flex items-center justify-between px-6 py-3 max-w-7xl mx-auto w-full sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md' : ''}`}>
            <Image
                src="/logo.png"
                alt="B-Locate Logo"
                width={50}
